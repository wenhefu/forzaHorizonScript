...
".venv\Scripts\python.exe" -m compileall -q v2 v3 v4 v4_gui_launcher.py
".venv\Scripts\pyinstaller.exe" --clean --noconfirm Forza6HelperV4GUI.spec
...
echo.
echo V4 GUI build complete: dist\Forza6HelperV4GUI.exe
